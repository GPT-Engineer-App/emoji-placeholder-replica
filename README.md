...
**Project**: emoji-placeholder-replica 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: make a replica of this site use emojis insterad of palceholde rimages 
...
```sh
git clone https://github.com/GPT-Engineer-App/emoji-placeholder-replica.git
cd emoji-placeholder-replica
npm i
